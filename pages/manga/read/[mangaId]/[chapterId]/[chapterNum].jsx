...
function ReadingPage({ manga, chapter, chapterNumber, chapterId }) {
  ...
  return (
    <>
      <Head>
        <title>{"Read " + (manga?.title.english || manga?.title.romaji) + " Chapter " + chapterNumber + " - KiruaRoll "}</title>
        <meta name="description" content={manga?.synopsis} />
        <meta name="keywords" content={manga?.genres} />
        <meta
          property="og:title"
          content={"Read " + (manga?.title.english || manga?.title.romaji) + " Chapter " + chapterNumber + " - KiruaRoll "}
        />
